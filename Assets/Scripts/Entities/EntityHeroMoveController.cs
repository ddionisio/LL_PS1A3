...
public class EntityHeroMoveController : MonoBehaviour {
    ...
    public delegate void CallbackEvent(EntityHeroMoveController controller);
    public delegate void CollisionCallbackEvent(EntityHeroMoveController controller, Collision2D col);
    public delegate void TriggerCallbackEvent(EntityHeroMoveController controller, Collider2D col);
